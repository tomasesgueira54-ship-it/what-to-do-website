...
// Validate ../../app/api/cron/refresh-events/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/cron/refresh-events">> = Specific
  const handler = {} as typeof import("../../app/api/cron/refresh-events/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
